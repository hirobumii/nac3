        ...
        nac3artiq-profile = pkgs.stdenvNoCC.mkDerivation {
          ...
          srcs = [
            (pkgs.fetchFromGitHub {
              owner = "m-labs";
              repo = "sipyco";
              rev = "4b15d47aa31bd375f8d977577bfb495765f6da7b";
              sha256 = "sha256-DU/88IzCiNKcrnTm+AV8L55t8YGb13ALHoTSxDJz/2g=";
            })
            (pkgs.fetchFromGitHub {
              owner = "m-labs";
              repo = "artiq";
              rev = "e355f0a8296c55e721f4132d593989c4160d66bd";
              sha256 = "sha256-vvbm8M5iV5tnSbc5931yO0W1igVXU6pIR2gTSEjluDE=";
            })
          ];
          buildInputs = [
